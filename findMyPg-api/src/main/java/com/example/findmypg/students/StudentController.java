...
public class StudentController {
	...
	public ResponseEntity<Student> addStudentWithImage(@RequestPart("studentDTO") String studentDTOString,
			@RequestPart(value = "image", required = false) MultipartFile image) throws IOException {

		ObjectMapper objectMapper = new ObjectMapper();
		StudentDTO studentDTO = objectMapper.readValue(studentDTOString, StudentDTO.class);
		Student savedStudent = studentService.addStudentsWithImage(studentDTO, image);
